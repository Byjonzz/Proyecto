        ...
        <ListItem disablePadding sx={{ display: 'block', mb: 0.5 }}>
          ...
          <Collapse in={openMenus.tecnico} timeout="auto" unmountOnExit>
            <List component="div" disablePadding sx={{ pl: 3, mt: 0.5, position: 'relative' }}>
              ...
              <ListItemButton onClick={() => handleNavigate('tecnico-instalaciones')} selected={isActive('tecnico-instalaciones')} sx={{ borderRadius: '6px', mb: 0.5, color: isActive('tecnico-instalaciones') ? '#a78bfa' : '#94a3b8', '&.Mui-selected': { backgroundColor: 'rgba(167, 139, 250, 0.15)' } }}>
                <ListItemIcon sx={{ color: 'inherit', minWidth: 32 }}><Build sx={{ fontSize: 18 }} /></ListItemIcon>
